...
import icon1 from "public/myavatar.jpeg"
          ...
          <div className='overflow-hidden'>
            ...
            <div className='flex flex-col gap-10 py-20 md:flex-row md:flex-wrap '>
              ...
              className='basis-1/3 flex-1'>
                <Image src={web1} className="rounded-lg  md:hover:scale-125  object-cover " alt='pt' />
              </m.div>
              <m.div
              variants={fadein}
              initial={"start"}
              ...
              className='basis-1/3 flex-1'>
                <Image src={web2} className="rounded-lg  md:hover:scale-125  object-cover " alt='pt'  />
              </m.div>
              <m.div
              variants={fadein}
              initial={"start"}
              ...
              className='basis-1/3 flex-1'>
                <Image src={web3} className="rounded-lg  md:hover:scale-125  object-cover " alt='pt'  />
              </m.div>
              <m.div
              variants={fadein}
              initial={"start"}
